...
#Reading in data
hotel.data <- read.csv('/Users/hotel_bookings.csv')
```
...
## Question 1) When is the best time of year to book a hotel room?
```{r}
# years 2015-2017
...
## Question 2) What is the busiest time of the year?
Important because the hotel can raise prices...



## Question 3) What is the optimal length of stay in order to get the best daily rate? 




## Question 4) Predict cancellations



## Question 4) How far in advance do people make bookings? Are they more inclined to cancel?
Lead time represents th number of days that elapsed between the entering date of the booking into the PMS and the arrival date.
...
ggplot(hotel.data, aes(x= lead_time))+
  ...
  labs(title = "lead time booking")

# visualizing cancellation rate
ggplot(hotel.data, aes(x= is_canceled))+
  geom_bar(bins=5)+ 
  labs(title = "canceled", subtitle = '0 = NO, 1 = YES')
...
## Seperating the data into City hotels and Resort hotels
```{r}
...
Q: Can we predict the number of room changes for 2 adults with 2 children.
```{r}
# Prediction using City Hotel data
city_predict <- lm()
...
```
Q: Can we predict the stays in weekend nights for 2 adults.
